...
(function($) {
    ...
    $('.mailchimp').ajaxChimp({
        ...
        url: "http:////spiro.us10.list-manage.com/subscribe/post?u=154351cf14bbcd81f1e000750&amp;id=6a68796abb" //Replace this with your own mailchimp post URL. Don't remove the "". Just paste the url inside "".  
    });
    ...
    function mainNav() {
        ...
        if (top > -1) $('.appear-on-scroll').stop().animate({
            "opacity": '1',
            "top": '0'
        });
